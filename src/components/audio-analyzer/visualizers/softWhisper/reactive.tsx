...
const SoftWhisperMaterial = shaderMaterial(
  {
    iTime: 0,
...
extend({ SoftWhisperMaterial })

type SoftWhisperMaterialImpl = {
  iTime: number
...
declare global {
  ...
  namespace JSX {
    interface IntrinsicElements {
      softWhisperMaterial: SoftWhisperMaterialImpl
    }
  }
}
