...
const LightPoolMaterial = shaderMaterial(
  ...
  // Fork of "shimmering" by vivavolt. https://shadertoy.com/view/ddB3WR
// 2023-07-05 08:45:11
...
void main() {
    ...
    vec3 ro = roty(vec3(3.), iTime * 0.3 + 0.5);
...
declare global {
  ...
  namespace JSX {
    interface IntrinsicElements {
      lightPoolMaterial: LightPoolMaterialImpl
    }
  }
}
