...
const InternalAudioScopeAnalyzer = ({ audioSource }: InternalAudioScopeAnalyzerProps) => {
  ...
  return (
    <>
      <ControlledAudioSource audio={audio} audioSource={audioSource as unknown as AudioSource} />
...
const AudioScopeAnalyzer = ({}: AudioScopeAnalyzerProps) => {
...
export default AudioScopeAnalyzer
